...
//	system("pause");
	system("iverilog -o love.out alu.v ALUctr.v CmpMode.v conflict.v datapathD.v datapathE.v datapathF.v  datapathM.v datapathW.v E_M.v forwardD.v ID_E.v IF_ID.v instruction.v M_W.v MdMode.v MemMode.v mips.v mips_test.v moduleD.v moduleF.v moduleM.v moduleW.v type_judge.v"); 
	system("vvp love.out");
//	system("pause"); 
	int i;
	FILE *marsf1=fopen("std.txt","r");
	FILE *verif1=fopen("love.txt","r");
